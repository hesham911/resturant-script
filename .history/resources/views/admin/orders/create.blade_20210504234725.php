                                    ...
                                    <div class="basic-repeater">
                                        <div data-repeater-list="group_a">
                                            <div data-repeater-item>
                                                <div class="row">
                                                    <div class="col-md-10 col-sm-12 form-group row">
                                                        {{-- <input type="text" class="form-control" name="number" id="number"
                                                               placeholder="{{__('users.employees.placeholder.phone')}}"> --}}
                                                        <select class="select2 order-products col-6" name="product_id">
                                                            <option disabled ></option>
                                                            @if (count($products) > 0)
                                                                @foreach ($products as $product)
                                                        ...
                                                        <input type="number" value="1" min="1" class="form-control col-6" name="quantity">
                                                    </div>
