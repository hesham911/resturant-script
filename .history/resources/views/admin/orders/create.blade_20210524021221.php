                               ...
                               @if($client)
                                    <div class="form-group row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">
                                            {{__('orders.table_id')}}</label>
                                        <div class="col-sm-10">
                                        <select class="select2" name="table_id">
                                            <option selected></option>
                                            @foreach ($client->user->phones->pluck('number') as $table)
                                                <option  value="value="{{$phone}}"" {{(old('table_id')==$table->id)? 'selected':''}}>
                                                    {{$table->name}} </option>
                                             @endforeach
                                        </select>
                                        </div>
                               ...
                               {{dd($client)}}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            class="form-control" id="client_id" placeholder="{{__('geo.zones.placeholder.name')}}" readonly>
                                        </div>
                                    </div>
                               @endif
