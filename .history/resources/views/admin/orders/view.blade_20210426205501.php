...
@section('content')
    ...
    <div class="page-header d-md-flex justify-content-between">
        ...
        <div class="mt-2 mt-md-0">
            <a href="#" class="btn btn-primary">{{__('orders.titles.print')}}</a>
        </div>
    </div>
    <div class="row col-6">
        <div>
        ...
        <h5>  خدمات اضافية : {{0}} {{__('app.settings.currency')}}</h5>
        <h4> اجمالي الفاتورة : {{$order->total_price}} {{__('app.settings.currency')}}</h4>
    </div>
@endsection
