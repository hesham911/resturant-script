...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h3> {{__('products.titles.create')}} </h3>
            <div>
                @include('admin.partials.breadcrumb',[
                    'parent' => [
                        'name' => __('products.titles.create'),
                    ]
                ])
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form  method="POST"  action="{{route('products.store') }}" class="repeater">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" placeholder="{{__('products.placeholder.name')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
